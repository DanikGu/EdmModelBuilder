...
namespace EdmModelBuilder;
public class CustomDataAccsessODataService
{
  private readonly IDbStructureBuilder _dbStructureBuilder;
  public CustomDataAccsessODataService(IDbStructureBuilder dbStructureBuilder)
  {
    _dbStructureBuilder = dbStructureBuilder;
  }

  public IEdmModel BuildOdataSchema(DbStructure dbStructure)
  {
